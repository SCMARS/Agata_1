...
Вопросы разрешены только каждое 2-е сообщение!"""    
    ...
    def _create_behavioral_instructions(self, behavioral_analysis: Dict[str, Any]) -> str:
        ...
        # РАЗНООБРАЗИЕ В НАЧАЛЕ ОТВЕТОВ
        instructions.append("НИКОГДА не начинай ответы одинаково! Избегай: 'Классно, что...', 'Это здорово...', 'Приятно слышать...'")
        instructions.append("Начинай разнообразно: 'Круто!', 'Ого!', 'Вау!', 'Серьезно?', 'Понимаю', 'Интересно', 'Ага', 'Точно', 'Хм', 'Да?'")
        instructions.append("Каждый ответ должен начинаться по-разному - как у живого человека!")
        instructions.append("Используй короткие междометия: 'Ох', 'Блин', 'Ух ты', 'Вот это да!', 'Не ожидала!'")
